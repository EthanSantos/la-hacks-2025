  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-950"> {/* Slightly lighter/darker background */}
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
        {/* --- Page Header --- */}
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight mb-6 text-gray-900 dark:text-gray-50 text-center sm:text-left">
              ...
              {[...Array(3)].map((_, i) => (
                <Card key={i} className="border-transparent shadow-sm bg-card">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <Skeleton className="h-5 w-5 rounded-sm bg-muted/50" />
                  </CardHeader>
                  <CardContent>
                    <Skeleton className="h-8 w-3/4 mt-1 bg-muted/50" />
                    <Skeleton className="h-4 w-1/2 mt-2 bg-muted/40" />
                  </CardContent>
                </Card>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-6">
                ...
                <Card className="border-transparent shadow-sm lg:col-span-3 bg-card">
                    <CardHeader>
                       ...
                       <Skeleton className="h-4 w-3/4 mt-2 bg-muted/40" />
                    </CardHeader>
                    <CardContent className="h-[350px] md:h-[400px] flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              <Card className="border-border/50 shadow-sm hover:shadow-md transition-shadow duration-200 rounded-lg overflow-hidden bg-card text-card-foreground">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-4 px-5">
                  ...
                  <ChartBarIcon className="h-4 w-4 text-muted-foreground" /> {/* Example Icon */}
                </CardHeader>
                <CardContent className="pb-4 px-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-6">
              ...
              <Card className="border-border/50 shadow-sm rounded-lg lg:col-span-3 overflow-hidden bg-card text-card-foreground">
                <CardHeader className="pb-2 pt-4 px-5">
                  <CardTitle className="text-lg font-medium">Hourly Sentiment Trend</CardTitle>
                ...
                <CardContent className="h-[350px] md:h-[400px] pb-4 px-2 md:px-3">
                  {trendData.length > 1 ? (
                    <Chart
                      chartType="LineChart"
                      width="100%"
              ...
              <Card className="border-border/50 shadow-sm rounded-lg lg:col-span-2 overflow-hidden bg-card text-card-foreground">
                ...
                <CardContent className="h-[350px] md:h-[400px] pb-4 px-2 md:px-3 flex flex-col items-center justify-center">
